...
if(key_jump && height_jump_reached == 0)
{
	...
	if(released == 0 && !place_meeting(x,y+1,face) && !place_meeting(x,y+1,wall) && !place_meeting(x,y+1,movingPlatform) && !key_jump_released)
	{
		vsp -=4;
	}
}
