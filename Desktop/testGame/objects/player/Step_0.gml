...
if(place_meeting(x,y+1,o_spike) || place_meeting(x-1,y,enemy) || (place_meeting(x+1,y,enemy)))
{	
...
if(key_jump_released)
	released = 1;  
if(place_meeting(x,y+1,wall) || place_meeting(x,y+1,movingPlatform))
	test = 0;
if(place_meeting(x,y-1,wall) || place_meeting(x,y-1,movingPlatform))
{
...
{
	if(test == 0 && released == 1 && key_jump && (place_meeting(x,y+1,wall) || place_meeting(x,y+1,movingPlatform)))
	{	
		released = 0;
		vsp = -13;
		test = 1;
	}
	if(test == 1 && released == 0&& !place_meeting(x,y+1,wall) && !place_meeting(x,y+1,movingPlatform))
	{
		vsp -=4;
	}
}
if(key_jump_released && !place_meeting(x,y+1,wall) && !place_meeting(x,y+1,movingPlatform))
{
	if(vsp < 0)
		vsp /= 1.5;
}
