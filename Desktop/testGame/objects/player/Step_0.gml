...
/// @DnDVersion : 1
/// @DnDHash : 29B65928
/// @DnDArgument : "code" "//setting variables for keys$(13_10)key_right = keyboard_check(vk_right);$(13_10)key_left = -keyboard_check(vk_left);$(13_10)key_jump = keyboard_check(vk_space);$(13_10)key_jump_released = keyboard_check_released(vk_space)$(13_10)key_sprint = keyboard_check(vk_shift);$(13_10)key_dash = keyboard_check(vk_control);$(13_10)//set move to -1 or 1 respectively$(13_10)move = key_left + key_right;$(13_10)//check $(13_10)if(key_sprint)$(13_10)	hsp = movespeed * move;$(13_10)else if(dashMode == 0)$(13_10)	hsp = (movespeed-6) * move;$(13_10)$(13_10)if(move == 0)$(13_10)	sprite_index = Standing;$(13_10)$(13_10)if(key_dash && dashMode == 0)$(13_10){$(13_10)    dashMode = 1;$(13_10)	speedx = hsp;$(13_10)	hsp += 20*move;$(13_10)}$(13_10)if(move > 0)$(13_10){$(13_10)	sprite_index = WalkingRight;$(13_10)	if(dashMode && hsp > speedx-10 && hsp > (movespeed-10) * move)$(13_10)		hsp += 3*move*-1;$(13_10)	else if(dashMode && (hsp <= speedx-10 || hsp <= (movespeed-10) * move))$(13_10)		dashMode = 0;$(13_10)}$(13_10)if(move < 0)$(13_10){$(13_10)	sprite_index = WalkingLeft;$(13_10)	if(dashMode && hsp < speedx+10 && hsp < (movespeed-10) * move)$(13_10)		hsp += 3*move*-1;$(13_10)	else if(dashMode && (hsp >= speedx+10 || hsp >= (movespeed-10) * move))$(13_10)		dashMode = 0;$(13_10)}$(13_10)$(13_10)$(13_10)	$(13_10)//jumping stuff$(13_10)vsp = vsp + grav;$(13_10)if(vsp < -16|| key_jump_released)$(13_10)	height_jump_reached = 1;$(13_10)if(key_jump && height_jump_reached == 0)$(13_10){$(13_10)	if(key_jump && (place_meeting(x,y+1,wall) || place_meeting(x,y+1,movingPlatform)))$(13_10)	{$(13_10)		show_debug_message("test")$(13_10)		vsp = -13;$(13_10)	}$(13_10)	if(!place_meeting(x,y+1,wall) && !place_meeting(x,y+1,movingPlatform) && !key_jump_released)$(13_10)		vsp -=4$(13_10)}$(13_10)if(key_jump_released && !place_meeting(x,y+1,wall) && !place_meeting(x,y+1,movingPlatform))$(13_10){$(13_10)	if(vsp < 0)$(13_10)		vsp /= 1.5;$(13_10)}$(13_10)$(13_10)if(place_meeting(x,y+1,wall))$(13_10){$(13_10)	height_jump_reached = 0;$(13_10)}$(13_10)$(13_10)//horizontal collision$(13_10)if(place_meeting(x+hsp,y,wall))$(13_10){$(13_10)	while(!place_meeting(x+sign(hsp),y,wall))$(13_10)	{$(13_10)		x +=sign(hsp);$(13_10)	}$(13_10)	hsp = 0;$(13_10)	$(13_10)}$(13_10)if(place_meeting(x+hsp,y,movingPlatform))$(13_10){$(13_10)	while(!place_meeting(x+sign(hsp),y,movingPlatform))$(13_10)	{$(13_10)		x +=sign(hsp);$(13_10)	}$(13_10)	hsp = 0;$(13_10)}$(13_10)//vertical collision$(13_10)if(place_meeting(x,y+vsp,wall))$(13_10){$(13_10)	while(!place_meeting(x,y+sign(vsp),wall))$(13_10)	{$(13_10)		y +=sign(vsp);$(13_10)	}$(13_10)	vsp = 0;$(13_10)	show_debug_message("help")$(13_10)	height_jump_reached = 0;$(13_10)}$(13_10)$(13_10)if(place_meeting(x,y+vsp,movingPlatform))$(13_10){	$(13_10)	if(movingPlatform.bool == 0)$(13_10)		x+= -2;$(13_10)	else$(13_10)		x+= 2;$(13_10)	while(!place_meeting(x,y+sign(vsp),movingPlatform))$(13_10)	{	$(13_10)		y +=sign(vsp);$(13_10)	}$(13_10)	vsp = 0;$(13_10)}$(13_10)$(13_10)x+=hsp;$(13_10)y+=vsp;"
...
{
	if(key_jump && (place_meeting(x,y+1,wall) || place_meeting(x,y+1,movingPlatform)))
	{
		show_debug_message("test")
		vsp = -13;
	}
	if(!place_meeting(x,y+1,wall) && !place_meeting(x,y+1,movingPlatform) && !key_jump_released)
		vsp -=4
}
