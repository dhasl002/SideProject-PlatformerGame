...
{
	if(test == 0 && released == 1 && key_jump && (place_meeting(x,y+1,face) || place_meeting(x,y+1,wall) || place_meeting(x,y+1,movingPlatform)))
	{
		released = 0;
		vsp = -13;
		test = 1;
	}
	if(test == 1 && released == 0 && !place_meeting(x,y+1,face) && !place_meeting(x,y+1,wall) && !place_meeting(x,y+1,movingPlatform))
	{
		vsp -=4;
	}
}
